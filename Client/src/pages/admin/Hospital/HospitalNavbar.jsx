...
function HospitalNavBar() {
            ...
            {admin && (
                <>
                    <List>
                        ...
                        <Link to={`/admin/hospital/${id}/update`}>
                            <ListItem disablePadding>
                                <ListItemButton>
                                    <ListItemIcon sx={{ color: "white" }}>
                                        <MailIcon />
                    ...
                    <List>
                        <Link to={`/admin/hospital/${id}/booking/current`}>
                            <ListItem disablePadding>
                                <ListItemButton>
                                    <ListItemIcon sx={{ color: "white" }}>
                                        <MailIcon />
                        ...
                        <Link to={`/admin/hospital/${id}/booking/records`}>
                            <ListItem disablePadding>
                                <ListItemButton>
                                    <ListItemIcon sx={{ color: "white" }}>
                                        <MailIcon />
                    ...
                    <List>
                        <ListItem disablePadding>
                            <ListItemButton>
                                <Link to="/admin" style={{ width: "100%" }}><button className='px-5 py-2 border border-yellow-400 text-yellow-400 font-bold w-full'>Back to Admin</button></Link>
                            </ListItemButton>
                        </ListItem>
                    </List>
                </>
    ...
    return (
        <div className='bg-green-950 border-b-2 border-b-white rounded-bl-lg rounded-br-lg shadow-md w-full h-fit py-2 px-5 flex justify-between items-center'>
